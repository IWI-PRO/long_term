...
vectorstore = Chroma(
    persist_directory="jbnsts_chroma",  # Chroma database location
...
def load_memories(state: State, config: RunnableConfig) -> State:
    ...
    if not convo.strip():  # Check if convo is empty or just whitespace
        return {"recall_memories": "No previous messages to search."}
